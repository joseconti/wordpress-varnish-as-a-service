...
WordPress Varnish as a Service ins a plugin for <a href="https://www.varnish-cache.org/">Varnish Cache</a> that purges/bans a cache server.
...
3. Configure your Varnish IP server and port. Also your Secret Key and Varnish version.
